...
plt.plot(u[0,:].value.A.flatten(),'-r',label="u1")
plt.plot(u[1,:].value.A.flatten(),'-b',label="u2")
...
x3 = x[2,:].value.A.flatten()
x4 = x[2,:].value.A.flatten()
plt.plot(range(51), x1,'-r',label="x1")
plt.plot(range(51), x2,'-b',label="x2")
plt.plot(range(51), x3,'-g',label="x3")
plt.plot(range(51), x4,'-k',label="x4")
plt.yticks([-25, 0, 25])
plt.ylim([-25, 25])
